...
- Runtime MCP OAuth credentials are now bound to their authorized server origin and fail closed when legacy or changed configuration lacks an exact match.
